...
class PerverzijaExtractor(
    override val name: String = "Perverzija",
    override val mainUrl: String = "https://tube.perverzija.com",
    ...
    override suspend fun getUrl(
        ...
        Xtremestream().getUrl(iframeUrl, url, subtitleCallback, callback)
    }
}
